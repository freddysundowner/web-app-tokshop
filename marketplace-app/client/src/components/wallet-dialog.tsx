...
export function WalletDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent
        className="max-w-[calc(100vw-2rem)] sm:max-w-md gap-0 max-h-[90dvh] overflow-y-auto !duration-150 [--tw-enter-translate-x:0px] [--tw-enter-translate-y:0px] [--tw-enter-scale:1] [--tw-exit-translate-x:0px] [--tw-exit-translate-y:0px] [--tw-exit-scale:1] [&>*]:min-w-0"
