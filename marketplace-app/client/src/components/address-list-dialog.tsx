  ...
  return (
    <>
      <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogContent
          className="max-w-[calc(100vw-2rem)] sm:max-w-[500px] max-h-[90dvh] flex flex-col !duration-150 [--tw-enter-translate-x:0px] [--tw-enter-translate-y:0px] [--tw-enter-scale:1] [--tw-exit-translate-x:0px] [--tw-exit-translate-y:0px] [--tw-exit-scale:1]"
        ...
        >
          ...
          <div className="flex-1 overflow-y-auto space-y-4 py-4 -mx-2 px-2">
            {/* Loading State */}
            {isLoading && (
