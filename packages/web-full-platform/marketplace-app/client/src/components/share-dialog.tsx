...
export function ShareDialog({ open, onOpenChange, url, title, description }: ShareDialogProps) {
  ...
  const handleShareInstagram = () => {
    ...
    // Also copy link to clipboard for user to paste
    navigator.clipboard.writeText(url).then(() => {
      toast({
    ...
    // Fallback: if Instagram app doesn't open in 2 seconds, try web version
    setTimeout(() => {
      onOpenChange(false);
    }, 500);
  };
        ...
        <div className="py-4">
          ...
          <div className="border-t pt-4">
            <div className="flex justify-around items-center gap-4">
              ...
              >
                <div className="w-14 h-14 rounded-full bg-gradient-to-br from-[#833AB4] via-[#E1306C] to-[#FD1D1D] flex items-center justify-center">
                ...
                <span className="text-xs text-black">Instagram</span>
              </button>
