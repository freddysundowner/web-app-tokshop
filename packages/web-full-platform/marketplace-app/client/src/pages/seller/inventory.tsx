              ...
              <table className="w-full min-w-[800px]">
                <thead>
                  <tr className="border-b bg-muted/50">
                    ...
                    <th className="text-left p-2 md:p-4 font-medium text-xs md:text-sm">Image</th>
                    <th className="text-left p-2 md:p-4 font-medium text-xs md:text-sm">Product</th>
                    <th className="text-left p-2 md:p-4 font-medium text-xs md:text-sm">Category</th>
                ...
                <tbody>
                  {Array.from({ length: 5 }).map((_, i) => (
                    <tr key={i} className="border-b">
                      ...
                      <td className="p-2 md:p-4">
                        <div className="w-10 h-10 md:w-12 md:h-12 bg-muted animate-pulse rounded" />
                      </td>
                      <td className="p-2 md:p-4">
                        <div className="space-y-2">
                          <div className="h-4 bg-muted animate-pulse rounded w-32 md:w-48" />
                          <div className="h-3 bg-muted animate-pulse rounded w-24 md:w-32 hidden md:block" />
                        </div>
                      </td>
                      <td className="p-2 md:p-4">
                  ...
                  <tbody>
                    {filteredProducts.map((product, index) => (
                      ...
                      >
                        ...
                        <td className="p-2 md:p-4">
                          <div className="w-10 h-10 md:w-12 md:h-12 bg-muted rounded overflow-hidden flex-shrink-0">
                        ...
                        <td className="p-2 md:p-4">
                          <div className="max-w-[120px] md:max-w-xs">
                            <div
                              className="font-medium text-xs md:text-sm text-foreground truncate"
                            ...
                            {product.description && (
                              <div
                                className="text-xs text-muted-foreground truncate mt-1 hidden md:block"
